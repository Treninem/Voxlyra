...
_ACHIEVEMENT_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "hundred_chapters": {
        "title": "Сто глав", "description": "Завершить сто текстовых глав.", "icon": "💯", "icon_asset": "/media/achievements/hundred_chapters.png", "group": "reader", "category": "reading", "rarity": "epic", "goal": 100
    },
    "night_reader": {
    ...
    "first_review": {
        "title": "Первый отзыв", "description": "Оставить первый опубликованный отзыв.", "icon": "⭐", "icon_asset": "/media/achievements/chatpack_first_review.png", "group": "reader", "category": "community", "rarity": "common", "goal": 1
    },
    "first_comment": {
    ...
    "reading_streak_7": {
        "title": "Семь дней подряд", "description": "Сохранять подтверждённую активность семь дней подряд.", "icon": "🔥", "icon_asset": "/media/achievements/reading_streak_7.png", "group": "reader", "category": "reading", "rarity": "rare", "goal": 7
    },
    "reading_streak_30": {
    ...
    "quote_collector": {
        "title": "Хранитель цитат", "description": "Сохранить десять цитат из произведений.", "icon": "📜", "icon_asset": "/media/achievements/chatpack_quote_collector.png", "group": "reader", "category": "reading", "rarity": "rare", "goal": 10
    },
    "premium_member": {
    ...
    "first_book": {
        "title": "Первая книга", "description": "Опубликовать первое произведение.", "icon": "✍️", "icon_asset": "/media/achievements/chatpack_first_book.png", "group": "author", "category": "author", "rarity": "rare", "goal": 1
    },
    "author_ten_chapters": {
    ...
    "thousand_readers": {
        "title": "1000 читателей", "description": "Собрать тысячу уникальных читателей.", "icon": "👥", "icon_asset": "/media/achievements/chatpack_thousand_readers.png", "group": "author", "category": "author", "rarity": "legendary", "goal": 1000
    },
    "author_month": {
    ...
    "five_hundred_chapters": {
        "title": "500 глав", "description": "Завершить пятьсот текстовых глав.", "icon": "📚", "icon_asset": "/media/achievements/pack24_reader_500.png", "group": "reader", "category": "reading", "rarity": "legendary", "goal": 500
    },
    "thousand_chapters": {
        "title": "Тысяча глав", "description": "Завершить тысячу текстовых глав.", "icon": "✦", "icon_asset": "/media/achievements/chatpack_thousand_chapters.png", "group": "reader", "category": "reading", "rarity": "legendary", "goal": 1000
    },
    "collector_fifty": {
    ...
    "author_five_hundred_chapters": {
        "title": "Автор 500 глав", "description": "Опубликовать пятьсот текстовых или графических глав.", "icon": "🪶", "icon_asset": "/media/achievements/pack24_author_500_chapters.png", "group": "author", "category": "author", "rarity": "legendary", "goal": 500
    },
    "author_fifty_books": {
    ...
    "reviewer_fifty": {
        "title": "Пятьдесят рецензий", "description": "Опубликовать пятьдесят содержательных отзывов на произведения.", "icon": "⭐", "icon_asset": "/media/achievements/reviewer_fifty.png", "group": "reader", "category": "community", "rarity": "epic", "goal": 50
    },
    "commentator_hundred": {
    ...
    "comic_five_thousand_pages": {
        "title": "Пять тысяч страниц", "description": "Просмотреть пять тысяч страниц комиксов, манги или манхвы.", "icon": "💠", "icon_asset": "/media/achievements/comic_five_thousand_pages.png", "group": "reader", "category": "comic", "rarity": "legendary", "goal": 5000
    },
    ...
    "reader_two_hundred_fifty_chapters": {
        "title": "250 глав", "description": "Завершить двести пятьдесят текстовых глав.", "icon": "📚", "icon_asset": "/media/achievements/pack24_reader_250.png", "group": "reader", "category": "reading", "rarity": "rare", "goal": 250
    },
    ...
    "reader_seventy_five_chapters": {
        "title": "75 глав", "description": "Завершить семьдесят пять текстовых глав.", "icon": "📖", "icon_asset": "/media/achievements/reader_seventy_five_chapters.png", "group": "reader", "category": "reading", "rarity": "rare", "goal": 75
    },
    "reader_one_hundred_fifty_chapters": {
    ...
    "reader_two_thousand_chapters": {
        "title": "2000 глав", "description": "Завершить две тысячи текстовых глав.", "icon": "✦", "icon_asset": "/media/achievements/reader_two_thousand_chapters.png", "group": "reader", "category": "reading", "rarity": "mythic", "goal": 2000
    },
    "reader_seven_thousand_five_hundred_chapters": {
    ...
    "reading_streak_365": {
        "title": "365 дней подряд", "description": "Сохранять подтверждённую активность триста шестьдесят пять дней подряд.", "icon": "✦", "icon_asset": "/media/achievements/pack24_streak_365.png", "group": "reader", "category": "reading", "rarity": "mythic", "goal": 365
    },
    ...
    "collector_two_hundred_fifty": {
        "title": "Личная библиотека 250", "description": "Сохранить двести пятьдесят произведений в личной библиотеке.", "icon": "🏛", "icon_asset": "/media/achievements/pack24_collector_250.png", "group": "reader", "category": "reading", "rarity": "legendary", "goal": 250
    },
    "reviewer_ten": {
        "title": "Десять рецензий", "description": "Опубликовать десять содержательных отзывов на произведения.", "icon": "⭐", "icon_asset": "/media/achievements/chatpack_reviewer_ten.png", "group": "reader", "category": "community", "rarity": "rare", "goal": 10
    },
    ...
    "audio_five_hundred_hours": {
        "title": "Мастер истории", "description": "Большой аудио-рубеж в мире историй VoxLyra.", "icon": "✦", "icon_asset": "/media/achievements/audio_five_hundred_hours.png", "group": "reader", "category": "audio", "rarity": "mythic", "goal": 30000
    },
    "comic_twenty_five_thousand_pages": {
        "title": "Вершитель саг", "description": "Пройти грандиозный путь по графическим историям VoxLyra.", "icon": "💠", "icon_asset": "/media/achievements/comic_twenty_five_thousand_pages.png", "group": "reader", "category": "comic", "rarity": "mythic", "goal": 25000
    },
    "quote_fifty": {
        "title": "Легендарный читатель", "description": "Собрать редкую коллекцию ярких мыслей, строк и цитат.", "icon": "📜", "icon_asset": "/media/achievements/quote_fifty.png", "group": "reader", "category": "reading", "rarity": "epic", "goal": 50
    },
    "author_fifty_chapters": {
        "title": "Мастер коллекции", "description": "Собрать заметную авторскую коллекцию и укрепить своё наследие в VoxLyra.", "icon": "🪶", "icon_asset": "/media/achievements/author_fifty_chapters.png", "group": "author", "category": "author", "rarity": "rare", "goal": 50
    },
    "author_two_hundred_fifty_chapters": {
        "title": "Автор 250 глав", "description": "Опубликовать двести пятьдесят текстовых или графических глав.", "icon": "🪶", "icon_asset": "/media/achievements/pack24_author_250_chapters.png", "group": "author", "category": "author", "rarity": "epic", "goal": 250
    },
    "author_thousand_chapters": {
        "title": "Автор 1000 глав", "description": "Опубликовать тысячу текстовых или графических глав.", "icon": "🏛", "icon_asset": "/media/achievements/pack24_author_1000_chapters.png", "group": "author", "category": "author", "rarity": "legendary", "goal": 1000
    },
    "author_five_books": {
        "title": "Путешественник миров", "description": "Открыть для читателей новые миры и самостоятельные произведения.", "icon": "📚", "icon_asset": "/media/achievements/author_five_books.png", "group": "author", "category": "author", "rarity": "rare", "goal": 5
    },
    "author_hundred_readers": {
        "title": "Покоритель вселенной", "description": "Собрать крепкую авторскую аудиторию и оставить яркий след.", "icon": "👥", "icon_asset": "/media/achievements/author_hundred_readers.png", "group": "author", "category": "author", "rarity": "epic", "goal": 100
    },
    "author_ten_thousand_readers": {
        "title": "Властелин знаний", "description": "Достичь высшей ступени признания и огромной аудитории.", "icon": "✦", "icon_asset": "/media/achievements/author_ten_thousand_readers.png", "group": "author", "category": "author", "rarity": "mythic", "goal": 10000
    },
    "completed_book_1": {
    ...
    "completed_books_5": {
        "title": 'Легенда знаний', "description": 'Сделать большой шаг по пути завершённых произведений VoxLyra.', "icon": '✦',
        "icon_asset": "/media/achievements/completed_books_5.png", "group": "reader",
        "category": "reading", "rarity": "rare", "goal": 5
    },
    "completed_books_25": {
        "title": "Двадцать пять завершённых миров", "description": "Полностью прочитать двадцать пять произведений.", "icon": '✦',
        "icon_asset": "/media/achievements/completed_books_25.png", "group": "reader",
        "category": "reading", "rarity": "epic", "goal": 25
    },
    "completed_books_50": {
        "title": "50 завершённых миров", "description": "Полностью прочитать пятьдесят произведений.", "icon": "✦",
        "icon_asset": "/media/achievements/pack24_completed_books_50.png", "group": "reader",
        "category": "reading", "rarity": "legendary", "goal": 50
    },
    "completed_books_100": {
    ...
    "completed_books_250": {
        "title": "250 завершённых миров", "description": "Полностью прочитать двести пятьдесят произведений.", "icon": '✦',
        "icon_asset": "/media/achievements/pack24_completed_books_250.png", "group": "reader",
    ...
    "active_days_365": {
        "title": "365 дней активности", "description": "Быть активным в VoxLyra в триста шестьдесят пять разные дни.", "icon": '✦',
        "icon_asset": "/media/achievements/pack24_active_days_365.png", "group": "reader",
    ...
    "active_days_1000": {
        ...
        "icon_asset": "/media/achievements/chatpack_active_days_1000.png", "group": "reader",
        "category": "reading", "rarity": "mythic", "goal": 1000
    },
    "genres_5": {
        "title": 'Пять жанров', "description": 'Завершить чтение глав в пяти разных жанрах.', "icon": '✦',
        "icon_asset": "/media/achievements/chatpack_genres_5.png", "group": "reader",
        "category": "reading", "rarity": "rare", "goal": 5
    },
    "genres_10": {
        "title": 'Карта жанров', "description": 'Завершить чтение глав в десяти разных жанрах.', "icon": '✦',
        "icon_asset": "/media/achievements/chatpack_genres_10.png", "group": "reader",
    ...
    "genres_20": {
        ...
        "icon_asset": "/media/achievements/chatpack_genres_20.png", "group": "reader",
    ...
    "notes_50": {
        ...
        "icon_asset": "/media/achievements/chatpack_notes_50.png", "group": "reader",
        "category": "reading", "rarity": "epic", "goal": 50
    },
    "notes_200": {
        "title": "Двести заметок", "description": "Создать двести личных заметок во время чтения.", "icon": '✦',
        "icon_asset": "/media/achievements/chatpack_notes_200.png", "group": "reader",
    ...
    "quotes_250": {
        "title": "250 цитат", "description": "Сохранить двести пятьдесят цитат из произведений.", "icon": '✦',
        "icon_asset": "/media/achievements/pack24_quotes_250.png", "group": "reader",
        "category": "reading", "rarity": "mythic", "goal": 250
    },
    "graphic_chapters_25": {
        "title": "25 графических глав", "description": "Завершить двадцать пять графических глав.", "icon": '🖼',
        "icon_asset": "/media/achievements/graphic_chapters_25.png", "group": "reader",
        "category": "comic", "rarity": "rare", "goal": 25
    },
    "graphic_chapters_250": {
        "title": "250 графических глав", "description": "Завершить двести пятьдесят графических глав.", "icon": '🖼',
        "icon_asset": "/media/achievements/pack24_graphic_chapters_250.png", "group": "reader",
    ...
    "author_words_100k": {
        ...
        "icon_asset": "/media/achievements/chatpack_author_words_100k.png", "group": "author",
    ...
    "author_rating_250": {
        "title": "250 высоких оценок", "description": "Получить двести пятьдесят опубликованных отзывов при средней оценке не ниже 4,7.", "icon": '🪶',
        "icon_asset": "/media/achievements/pack24_author_rating_250.png", "group": "author",
    ...
    "audio_chapters_600": {"title": "600 аудиоглав", "description": "Прослушать до конца шестьсот опубликованных аудиоглав.", "icon": "🎧", "icon_asset": "/media/achievements/pack24_audio_chapters_600.png", "group": "reader", "category": "audio", "rarity": "legendary", "goal": 600},
    "reviews_350": {"title": "350 рецензий", "description": "Опубликовать триста пятьдесят содержательных отзывов на произведения.", "icon": "⭐", "icon_asset": "/media/achievements/pack24_reviews_350.png", "group": "reader", "category": "community", "rarity": "legendary", "goal": 350},
    "quotes_350": {"title": "350 цитат", "description": "Сохранить триста пятьдесят значимых цитат из произведений.", "icon": "📜", "icon_asset": "/media/achievements/pack24_quotes_350.png", "group": "reader", "category": "reading", "rarity": "mythic", "goal": 350},
    "comments_400": {"title": "400 комментариев", "description": "Опубликовать четыреста комментариев к главам.", "icon": "💬", "icon_asset": "/media/achievements/pack24_comments_400.png", "group": "reader", "category": "community", "rarity": "legendary", "goal": 400},
...
_RARE_ACHIEVEMENT_CATALOG: dict[str, dict[str, Any]] = {
    "founding_member": {
        ...
        "description": "Сделать большой шаг по пути завершённых произведений VoxLyra.",
        "icon": "✦",
...
async def sync_user_achievements(user_id: int) -> dict[str, Any]:
    ...
    async with connect() as db:
        ...
        candidates = {
            ...
            "reader_seventy_five_chapters": (completed >= 75, completed),
            "reader_one_hundred_fifty_chapters": (completed >= 150, completed),
            "reader_seven_hundred_fifty_chapters": (completed >= 750, completed),
            "reader_one_thousand_five_hundred_chapters": (completed >= 1500, completed),
            "reader_two_thousand_chapters": (completed >= 2000, completed),
            "reader_seven_thousand_five_hundred_chapters": (completed >= 7500, completed),
            ...
            "completed_books_50": (completed_books >= 50, completed_books),
            ...
            "audio_chapters_600": (completed_audio_chapters >= 600, completed_audio_chapters),
            "reviews_350": (reviews >= 350, reviews),
            "quotes_350": (quotes_count >= 350, quotes_count),
            "comments_400": (comments_count >= 400, comments_count),
            "active_days_60": (active_days >= 60, active_days),
            "author_seven_hundred_chapters": (published_chapters >= 700, published_chapters),
            ...
            "reader_one_hundred_twenty_chapters": (completed >= 120, completed),
            "reader_two_hundred_ten_chapters": (completed >= 210, completed),
            "completed_books_300": (completed_books >= 300, completed_books),
            "reader_three_hundred_seventy_five_chapters": (completed >= 375, completed),
            ...
            "reader_nine_hundred_chapters": (completed >= 900, completed),
            "reader_one_thousand_chapters": (completed >= 1000, completed),
            "author_five_hundred_chapters": (published_chapters >= 500, published_chapters),
    ...
    live_progress = {
        ...
        "reader_seventy_five_chapters": completed,
        "reader_one_hundred_fifty_chapters": completed,
        "reader_seven_hundred_fifty_chapters": completed,
        "reader_one_thousand_five_hundred_chapters": completed,
        "reader_two_thousand_chapters": completed,
        "reader_seven_thousand_five_hundred_chapters": completed,
        ...
        "completed_books_50": completed_books,
        ...
        "audio_chapters_600": completed_audio_chapters,
        "reviews_350": reviews,
        "quotes_350": quotes_count,
        "comments_400": comments_count,
        "active_days_60": active_days,
        "author_seven_hundred_chapters": published_chapters,
        "reviews_250": reviews,
        "graphic_chapters_550": completed_graphic_chapters,
        "active_days_300": active_days,
        "quotes_120": quotes_count,
        "reader_one_hundred_twenty_chapters": completed,
        "reader_two_hundred_ten_chapters": completed,
        "completed_books_300": completed_books,
        "reader_three_hundred_seventy_five_chapters": completed,
        ...
        "reader_nine_hundred_chapters": completed,
        "reader_one_thousand_chapters": completed,
        "author_five_hundred_chapters": published_chapters,
