...
OWNER_BUILD_VERSION = "v1.13.12"
OWNER_BUILD_NAME = "исправление настроек расписания публикаций"
...
WORKING_BUILD_STAGE = "v1.13.12 · исправление настроек расписания публикаций"
