...
OWNER_BUILD_VERSION = "v1.11.10"
OWNER_BUILD_NAME = "база и комиксы сохранены · исправлена HTML-разметка публикаций и уведомлений"
...
WORKING_BUILD_STAGE = "v1.11.10 · корректная разметка Telegram"
