...
OWNER_BUILD_VERSION = "v1.14.0.3"
OWNER_BUILD_NAME = "hotfix OOM и отложенной загрузки приложения"
...
WORKING_BUILD_STAGE = "v1.14.0.3 · hotfix OOM и отложенной загрузки приложения"
