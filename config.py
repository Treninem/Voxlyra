...
OWNER_BUILD_VERSION = "v1.11.6"
OWNER_BUILD_NAME = "база и комиксы сохранены · мобильная сетка кабинета автора без наложений"
...
WORKING_BUILD_STAGE = "v1.11.6 · мобильная доводка кабинета автора"
