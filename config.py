...
OWNER_BUILD_VERSION = "v1.11.5"
OWNER_BUILD_NAME = "база и комиксы сохранены · исправлена иконка профиля · мобильная личная полка"
...
WORKING_BUILD_STAGE = "v1.11.5 · исправление профиля и мобильной личной полки"
